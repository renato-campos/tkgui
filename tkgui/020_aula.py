# OBJETIVO DA AULA: trabalhar inserir e pesquisar as bases de dados
from tkinter import *
...
def query():
    ...
    for reg in saida:
        arquivo += f'A pessoa se chama {reg[0]} {reg[1]} e reside na {reg[2]}, {reg[3]}/{reg[4]}, CEP {reg[5]}\n'
    
    arquivo_label = Label(janela, text=arquivo)
    arquivo_label.grid(row=8, column=0, columnspan=2)
...
btn_query.grid(row=7,column=0, columnspan=2,padx=10, pady=10, ipadx=100)
